...
message("Dimensions of the training set:")
dim(trainingset)
message("Dimensions of the test set:")
dim(testset)
```
...
message("New dimensions of the training set:")
dim(trainingset)
message("New dimensions of the test set:")
dim(testset)
```
...
message("The following features are removed:")
nzfeatures
message("New dimensions of the training set:")
dim(trainingset)
message("New dimensions of the test set:")
...
dtconfusion
plot(dtconfusion$table, col = dtconfusion$byClass)
```
